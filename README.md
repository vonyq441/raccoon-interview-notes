...
VitePress 在本地开发时读取外层项目根目录的智能巡检、中央调度平台和模拟面试记录文档，单向生成本仓库的云端副本与 `docs` 构建副本。外层源文档是唯一可编辑版本，站点脚本不会向它们写入内容；GitHub Actions 则读取仓库内已提交的副本。
...
- `../面试.md`、`../甘肃具身智能示范应用-中央调度平台设计与面试.md`、`../模拟面试记录.md`：本地唯一源文件，只读，脚本绝不回写。
- `面试.md`、`中央调度平台设计与面试.md`、`模拟面试记录.md`：用于提交到独立文档仓库的云端副本，由同步脚本覆盖。
- `docs/interview.md`、`docs/central-scheduling.md`、`docs/mock-interview.md`：VitePress 构建副本，由同步脚本覆盖，不要手工编辑。
