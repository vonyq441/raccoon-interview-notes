...
const documents = [
  ...
  {
    workspace: resolve(siteRoot, '..', '甘肃具身智能示范应用-中央调度平台V2实施设计.md'),
    repository: resolve(siteRoot, '中央调度平台V2实施设计.md'),
    destination: resolve(siteRoot, 'docs', 'central-scheduling-v2-design.md')
  },
  {
  ...
  {
    workspace: resolve(siteRoot, '..', 'AI-Agent智能体面试题学习文档.md'),
    repository: resolve(siteRoot, 'AI-Agent智能体面试题学习文档.md'),
    destination: resolve(siteRoot, 'docs', 'ai-agent-interview.md')
  }
]
